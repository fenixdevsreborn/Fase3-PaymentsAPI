...
/// <summary>Meter facade for Payments API: HTTP + payments.created/paid/failed + exceptions.</summary>
public sealed class FcgMeters
{
    ...
    private readonly Counter<long> _paymentsPaid;
    ...
    public FcgMeters(string meterName)
    {
        ...
        _paymentsCreated = _meter.CreateCounter<long>(FcgMetricNames.PaymentsCreated);
        _paymentsPaid = _meter.CreateCounter<long>(FcgMetricNames.PaymentsPaid);
        _paymentsFailed = _meter.CreateCounter<long>(FcgMetricNames.PaymentsFailed);
    ...
    public void RecordPaymentCreated() => _paymentsCreated.Add(1);
    public void RecordPaymentPaid() => _paymentsPaid.Add(1);
